...
def predict_transform(prediction, anchors, inp_dim=416, num_classes=3):
...
def rects_prepare(output, inp_dim=416, num_classes=3):
    prediction = None
    ...
    for key, value in output.items():
        ...
        elif key == "layer16-conv":
            anchors = [(81,82),  (135,169),  (344,319)]
            #anchors = [(10,14), (23,27), (37,58)]
        elif key == "layer23-conv":
            #anchors = [(81,82),  (135,169),  (344,319)]
            anchors = [(10,14), (23,27), (37,58)]
        if prediction is None:
            prediction = predict_transform(value, anchors=anchors, inp_dim=inp_dim)
        else:
            prediction = np.concatenate([prediction, predict_transform(value, anchors=anchors, inp_dim=inp_dim)], axis=1)
